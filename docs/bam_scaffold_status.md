...
| `diff_s1_ghost_determinant_probe` | supplies the measure's gauge sector (PR #115 flagged it; PR #116 did matter). Worldline reparametrization Diff(S¹): gauge-fixing the einbein to constant leaves 1 Teichmüller modulus L (circumference = Schwinger proper time) + 1 CKV (rigid U(1) rotation). FP operator P ξ~dξ/dτ ⟹ P†P~−d²/dτ² (periodic); kernel = constants = the 1 CKV. Zeta-regularized (same method as #116): ζ_ghost(0)=−1, det'(−d²/dτ²)=L² (verified machine-precision L=2π,1,3.32,5). The CKV zero mode IS PR #74's 1/(2π): dividing out Vol(U(1))=L gives dL/L moduli measure, for the closure loop L=2π ⟹ 1/L=1/(2π) (gauge origin of the closure quantum). Anomaly-free: 1D worldline has no conformal anomaly (vs 2D string c=−26); only nontrivial anomaly is the discrete Z₂ (odd-k, PR #115). One-loop measure now Z=Σ∫(dL/L)·det'_ghost·det^{−1/2}_matter·e^{−S}, all finite; open: abs Z (κ₅²/Λ₅), multi-loop | DIFF_S1_FADDEEV_POPOV_GHOST_DETERMINANT_FINITE_ANOMALY_FREE |
