...
scale is geometric, not tuned.** What remains is the precise `m_ν` and
its generation spread (a geometry-only `(t, ε)` gives `m_ν ∝ m_D`,
a ×2.7 spread, vs the observed ×18) — the mixing sector / a
