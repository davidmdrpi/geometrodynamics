...
everywhere, so `Γ(0)` is indefinite — **`A = 0` is unstable at every separation**,
which no placement of the mouths fixes.
...
# Verdict: THE_POSITIVE_SECTOR_IS_A_LIGHT_CONE_AT_GAMMA_ZERO  (8/8)
