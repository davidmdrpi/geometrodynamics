...
_2026-08-14T03:53:53.883320+00:00_
...
## T4_the_branch_set_is_finite_and_bounded_by_the_delay — PASS

- **rows**:
    - delay_over_two_pi=0.5, winding_bound=0, complete_branch_count=1
    - delay_over_two_pi=1, winding_bound=1, complete_branch_count=2
    - delay_over_two_pi=2, winding_bound=2, complete_branch_count=4
    - delay_over_two_pi=3, winding_bound=3, complete_branch_count=6
    - delay_over_two_pi=4, winding_bound=4, complete_branch_count=8
- **worst_excess_over_the_bound**: 0
- **no_feasible_branch_exceeds_the_bound**: True
- **brute_enumeration_reached_winding**: 11
- **the_branch_set_is_finite**: True
- **so_branch_completeness_is_exact_not_truncated**: True
- **why**: a leg length is at least 2πk and the two legs must sum to |Δ|, so k₁ + k₂ ≤ ⌊|Δ|/2π⌋

## T5_discrete_events_survive_branch_completion — PASS

- **rows**:
    - branch_pairs=2, events_branch_complete=4, events_principal_only=0, ranks=[5]
    - branch_pairs=2, events_branch_complete=0, events_principal_only=0, ranks=[]
    - branch_pairs=25, events_branch_complete=0, events_principal_only=0, ranks=[]
    - branch_pairs=10, events_branch_complete=4, events_principal_only=0, ranks=[5]
    - branch_pairs=4, events_branch_complete=2, events_principal_only=0, ranks=[5]
    - branch_pairs=5, events_branch_complete=4, events_principal_only=0, ranks=[5]
    - branch_pairs=15, events_branch_complete=4, events_principal_only=0, ranks=[5]
    - branch_pairs=0, events_branch_complete=0, events_principal_only=0, ranks=[]
- **configurations**: 8
- **configurations_with_events**: 5
- **total_events**: 18
- **events_at_full_rank_5**: 18
- **every_event_still_isolated**: True
- **the_candidate_count_can_grow**: True
- **a_union_of_finitely_many_discrete_sets_is_discrete**: True
- **so_discreteness_survives_branch_completion**: True

## T6_the_shared_throat_obstruction_survives_completion — PASS

- **rows**:
    - feasible_branches=6, distinct_pairs=15, pairs_restoring_rank_5=0
    - feasible_branches=3, distinct_pairs=3, pairs_restoring_rank_5=0
    - feasible_branches=3, distinct_pairs=3, pairs_restoring_rank_5=0
    - feasible_branches=4, distinct_pairs=6, pairs_restoring_rank_5=0
    - feasible_branches=3, distinct_pairs=3, pairs_restoring_rank_5=0
    - feasible_branches=4, distinct_pairs=6, pairs_restoring_rank_5=0
    - feasible_branches=2, distinct_pairs=1, pairs_restoring_rank_5=0
    - feasible_branches=3, distinct_pairs=3, pairs_restoring_rank_5=0
    - feasible_branches=5, distinct_pairs=10, pairs_restoring_rank_5=0
    - feasible_branches=2, distinct_pairs=1, pairs_restoring_rank_5=0
- **configurations_with_two_or_more_branches**: 10
- **distinct_branch_pairs_tested**: 51
- **pairs_that_restored_full_rank**: 0
- **the_obstruction_survives_branch_completion**: True
- **and_this_is_now_exhaustive_not_a_scan**: the winding is bounded by the delay, so every distinct branch pair through the shared throat was tried, not a sample

## T7_the_delay_dependence_survives_branch_completion — PASS

- **points_sampled**: 600
- **fraction_closable_by_choosing_a_delay**: 1
- **every_point_is_closable_on_the_principal_branch_alone**: True
- **extra_branches_only_add_ways_to_close**: True
- **so_the_delay_must_still_be_given**: True

## T8_the_events_are_discrete_and_locally_isolated — PASS
...
## T9_removing_an_equation_is_a_dimensionality_control — PASS
...
## T10_a_shared_throat_cannot_carry_the_pair — PASS
...
## T11_the_delays_must_be_given_not_solved_for — PASS
...
## T12_the_threshold_is_a_separate_condition — PASS
...
## T13_the_conjugacy_is_carried_not_derived — PASS
