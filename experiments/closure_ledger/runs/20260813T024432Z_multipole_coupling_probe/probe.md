...
_generated 2026-08-13T02:44:32.201628+00:00_
...
## T4_the_coupling_generalises_to_five_dimensions — PASS
- **rows**:
    - ell=0, closed_form_D5=0, brute_force_D5=1.73472e-12, relative_error=1.73472e-12, laplacian_eigenvalue_on_S3=0
    - ell=1, closed_form_D5=0.024, brute_force_D5=0.0240011, relative_error=4.56328e-05, laplacian_eigenvalue_on_S3=3
    - ell=2, closed_form_D5=0.0170667, brute_force_D5=0.0170684, relative_error=0.000102743, laplacian_eigenvalue_on_S3=8
    - ell=3, closed_form_D5=0.0096, brute_force_D5=0.00960186, relative_error=0.000193504, laplacian_eigenvalue_on_S3=15
    - ell=4, closed_form_D5=0.0049152, brute_force_D5=0.0049168, relative_error=0.000326076, laplacian_eigenvalue_on_S3=24
- **b**: 2
- **a**: 5
- **dim**: 5
- **worst_relative_error**: 0.000326076
- **the_D5_closed_form_is_confirmed**: True
- **ell_zero_vanishes_in_five_dimensions**: True
- **kappa_D4**: [0.11111111111111113, 0.04, 0.020408163265306124]
- **kappa_D5**: [0.5, 0.3333333333333333, 0.25]
...
## T5_the_translation_mode_does_not_couple — PASS
- **rows**:
...
## T6_the_pure_dipole_is_not_a_translation — PASS
- **rows**:
...
## T7_translation_invariance_is_exact — PASS
- **rows**:
...
## T8_the_area_cost_is_the_exact_rational — PASS
- **rows**:
...
## T9_the_coupling_is_screened_by_separation — PASS
- **rows**:
...
## T10_the_shear_response_is_an_input — PASS
- **rows**:
