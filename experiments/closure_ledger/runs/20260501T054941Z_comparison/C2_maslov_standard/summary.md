...
**Run:** 2026-05-01T05:49:41+00:00
**Experiment:** closure_ledger.layer2
**Transport convention:** `T2_sign_flip`
**χ (Hopf fibre):** 0.0
**S(k) candidate:** `C2_maslov_standard`

**Overall status:** Layer 2 FALSIFIES candidate 'C2_maslov_standard': lepton ledger does NOT close universally mod 2π (spread 3.454e+00).
...
|---|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | 2.000π | 1.000π | 1.000π | 0.000π | 0.639π | — | 4.639π | 0.638760π | partial_fails_to_close |
| muon | 3 | 6.000π | 1.000π | 1.000π | 0.000π | 1.738π | — | 9.738π | 1.738289π | partial_fails_to_close |
| tau | 5 | 10.000π | 1.000π | 1.000π | 200.000π | 2.999π | — | 214.999π | 0.998617π | partial_fails_to_close |
...
- Per-lepton totals mod 2π (in units of π): ['0.638760', '1.738289', '0.998617']
- Spread across leptons: 3.45e+00
...
### Next steps
- Read the universality_check on the lepton ledger: candidate `C2_maslov_standard` either preserves closure mod 2π (supports the candidate) or breaks it (falsifies the candidate; rerun with another wired candidate).
