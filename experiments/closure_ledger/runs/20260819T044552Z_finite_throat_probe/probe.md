...
_2026-08-19T04:45:52.707963+00:00_
...
- **the_scope**: the massless (m = 0) tube kernel: with m ≠ 0 the front is still at L but e^{ikL} is dispersive, and the coupled R = (A − Γ)⁻¹ additionally carries the ambient's d-paths
...
- **the_band**: A varies through kL, so freezing it is defensible over an O(1/L) FREQUENCY range; the λ-width is the local linearization of that and not a separate law
...
## T8_the_growing_mode_is_interface_localized — PASS
...
- **by_length**:
    - length=0.4, sigma_star=1.76858, closed_form=1, sigma_times_L=0.707432
    - length=0.9, sigma_star=1.41666, closed_form=1, sigma_times_L=1.27499
    - length=1.8, sigma_star=1.22556, closed_form=1, sigma_times_L=2.20601
    - length=3, sigma_star=1.15197, closed_form=1, sigma_times_L=3.4559
- **length_spread_at_the_working_area**: 0.616614
- **the_working_throat_is_not_asymptotic**: True
...
- **the_diagnosis**: the mode is generated at the point-mouth/tube INTERFACE; only in the σL, σd ≫ 1 limit does it localize to a single mouth and stop knowing L and d — and the working throat is not in that limit, where σ* still runs 1.769…1.152 over L = 0.4…3
...
- **sigma_star**: 1.57523
- **true_onset**: 0.6
- **frequency_spacing**: 0.020944
- **rows**:
    - clearance=-0.03, contour=1.54523, above_the_mode=False, clearance_over_spacing=-1.43239, resolved=False, onset=0, pedestal=0.991906
    - clearance=0.02, contour=1.59523, above_the_mode=True, clearance_over_spacing=0.95493, resolved=False, onset=0, pedestal=0.00261455
    - clearance=0.3, contour=1.87523, above_the_mode=True, clearance_over_spacing=14.3239, resolved=True, onset=0.46463, pedestal=1.02588e-16
    - clearance=0.8, contour=2.37523, above_the_mode=True, clearance_over_spacing=38.1972, resolved=True, onset=0.460052, pedestal=7.5865e-17
    - clearance=1.5, contour=3.07523, above_the_mode=True, clearance_over_spacing=71.6197, resolved=True, onset=0.455475, pedestal=6.96993e-17
- **pedestal_below**: 0.991906
- **pedestal_above_but_unresolved**: 0.00261455
- **pedestal_resolved**: 1.02588e-16
- **onset_below**: 0
- **onset_resolved**: 0.455475
- **onset_spread_across_resolved**: 0.00915527
- **a_contour_below_the_mode_breaks_causality**: True
- **clearing_the_mode_is_not_enough**: True
- **the_resolved_contours_are_clean**: True
- **the_recovered_onset_converges**: True
- **the_rule**: TWO conditions, not one: ε > σ* is the analytic Bromwich requirement, and ε − σ* ≫ 2π/span is the numerical one. Both have closed forms, so the contour is placed before the solve
