...
**χ (Hopf fibre):** 0.0
**S(k) candidate:** `B1_single_angular_mode`

**Overall status:** Layer 2 FALSIFIES candidate 'B1_single_angular_mode': lepton ledger does NOT close universally mod 2π (spread 3.814e-01).
...
| muon | 3 | 6.000π | 1.000π | 1.000π | 0.000π | 0.771π | — | 8.771π | 0.770744π | partial_fails_to_close |
| tau | 5 | 10.000π | 1.000π | 1.000π | 200.000π | 0.760π | — | 212.760π | 0.760477π | partial_fails_to_close |

## Radial bulk channel — per-mode breakdown

| lepton | k | (l, n) | ω(l, n) | Φ(l, n) | weight | weight·Φ | N_tp | Δ_maslov | status |
|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | (l=1, n=0) | 1.054727 | 0.881876π | 1.000000 | 0.881876π | 1 | 0 | computed |
| muon | 3 | (l=3, n=0) | 1.219083 | 0.770744π | 1.000000 | 0.770744π | 1 | 0 | computed |
| tau | 5 | (l=5, n=0) | 1.395973 | 0.760477π | 1.000000 | 0.760477π | 1 | 0 | computed |

## Universality check (Layer 2)

- Per-lepton totals mod 2π (in units of π): ['0.881876', '0.770744', '0.760477']
- Spread across leptons: 3.81e-01
...
### Next steps
- Read the universality_check on the lepton ledger: candidate `B1_single_angular_mode` either preserves closure mod 2π (supports the candidate) or breaks it (falsifies the candidate; rerun with another wired candidate).
