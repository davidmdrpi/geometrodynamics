...
**χ (Hopf fibre):** 0.0
**S(k) candidate:** `C2_eigenvector_weighted_B2`

**Overall status:** Layer 2 FALSIFIES candidate 'C2_eigenvector_weighted_B2': lepton ledger does NOT close universally mod 2π (spread 2.573e+00).
...
|---|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | 2.000π | 1.000π | 1.000π | 0.000π | 1.059π | — | 5.059π | 1.059227π | partial_fails_to_close |
| muon | 3 | 6.000π | 1.000π | 1.000π | 0.000π | 1.818π | — | 9.818π | 1.817711π | partial_fails_to_close |
| tau | 5 | 10.000π | 1.000π | 1.000π | 200.000π | 2.999π | — | 214.999π | 0.998727π | partial_fails_to_close |

## Radial bulk channel — per-mode breakdown

| lepton | k | (l, n) | ω(l, n) | Φ(l, n) | weight | weight·Φ | N_tp | Δ_maslov | status |
|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | (l=1, n=0) | 1.054727 | 0.881876π | 0.840935 | 0.741600π | 1 | 0 | computed |
| electron | 1 | (l=1, n=1) | 1.974381 | 1.994352π | 0.158673 | 0.316449π | 0 | 0 | computed |
| electron | 1 | (l=1, n=2) | 2.894070 | 2.999437π | 0.000393 | 0.001178π | 0 | 0 | computed |
| muon | 3 | (l=1, n=0) | 1.054727 | 0.881876π | 0.158844 | 0.140081π | 1 | 0 | computed |
| muon | 3 | (l=1, n=1) | 1.974381 | 1.994352π | 0.841087 | 1.677423π | 0 | 0 | computed |
| muon | 3 | (l=1, n=2) | 2.894070 | 2.999437π | 0.000069 | 0.000207π | 0 | 0 | computed |
| tau | 5 | (l=1, n=0) | 1.054727 | 0.881876π | 0.000221 | 0.000195π | 1 | 0 | computed |
| tau | 5 | (l=1, n=1) | 1.974381 | 1.994352π | 0.000241 | 0.000480π | 0 | 0 | computed |
| tau | 5 | (l=1, n=2) | 2.894070 | 2.999437π | 0.999538 | 2.998053π | 0 | 0 | computed |

## Universality check (Layer 2)

- Per-lepton totals mod 2π (in units of π): ['1.059227', '1.817711', '0.998727']
- Spread across leptons: 2.57e+00
...
### Next steps
- Read the universality_check on the lepton ledger: candidate `C2_eigenvector_weighted_B2` either preserves closure mod 2π (supports the candidate) or breaks it (falsifies the candidate; rerun with another wired candidate).
