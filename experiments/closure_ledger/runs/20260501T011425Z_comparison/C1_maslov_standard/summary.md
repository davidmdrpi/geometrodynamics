...
**Run:** 2026-05-01T01:14:25+00:00
**Experiment:** closure_ledger.layer2
**Transport convention:** `T2_sign_flip`
**χ (Hopf fibre):** 0.0
**S(k) candidate:** `C1_maslov_standard`

**Overall status:** Layer 2 FALSIFIES candidate 'C1_maslov_standard': lepton ledger does NOT close universally mod 2π (spread 3.257e-01).
...
|---|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | 2.000π | 1.000π | 1.000π | 0.000π | 0.364π | — | 4.364π | 0.364195π | partial_fails_to_close |
| muon | 3 | 6.000π | 1.000π | 1.000π | 0.000π | 0.288π | — | 8.288π | 0.288396π | partial_fails_to_close |
| tau | 5 | 10.000π | 1.000π | 1.000π | 200.000π | 0.261π | — | 212.261π | 0.260506π | partial_fails_to_close |

## Radial bulk channel — per-mode breakdown

| lepton | k | (l, n) | ω(l, n) | Φ(l, n) | weight | weight·Φ | N_tp | Δ_maslov | status |
|---|---|---|---|---|---|---|---|---|---|
| electron | 1 | (l=1, n=0) | 1.054727 | 0.381876π | 0.840935 | 0.321133π | 1 | -0.500000π | computed |
| electron | 1 | (l=3, n=0) | 1.219083 | 0.270744π | 0.158673 | 0.042960π | 1 | -0.500000π | computed |
| electron | 1 | (l=5, n=0) | 1.395973 | 0.260477π | 0.000393 | 0.000102π | 1 | -0.500000π | computed |
| muon | 3 | (l=1, n=0) | 1.054727 | 0.381876π | 0.158844 | 0.060659π | 1 | -0.500000π | computed |
| muon | 3 | (l=3, n=0) | 1.219083 | 0.270744π | 0.841087 | 0.227719π | 1 | -0.500000π | computed |
| muon | 3 | (l=5, n=0) | 1.395973 | 0.260477π | 0.000069 | 0.000018π | 1 | -0.500000π | computed |
| tau | 5 | (l=1, n=0) | 1.054727 | 0.381876π | 0.000221 | 0.000084π | 1 | -0.500000π | computed |
| tau | 5 | (l=3, n=0) | 1.219083 | 0.270744π | 0.000241 | 0.000065π | 1 | -0.500000π | computed |
| tau | 5 | (l=5, n=0) | 1.395973 | 0.260477π | 0.999538 | 0.260357π | 1 | -0.500000π | computed |

## Universality check (Layer 2)

- Per-lepton totals mod 2π (in units of π): ['0.364195', '0.288396', '0.260506']
...
- Open questions: Does the per-mode turning-point count vary across the depth basis B1 modes (l ∈ {1, 3, 5}, n = 0)? The Tangherlini centrifugal barrier scales with l(l+d−3), so the inner soft turning point is present for every l; whether the integration grid actually spans both turning points or only one fixes whether the correction is uniform −π/2 or differential.
...
### Next steps
- Read the universality_check on the lepton ledger: candidate `C1_maslov_standard` either preserves closure mod 2π (supports the candidate) or breaks it (falsifies the candidate; rerun with another wired candidate).
