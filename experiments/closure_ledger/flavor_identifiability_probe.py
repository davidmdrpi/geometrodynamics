...
equally well at the same masses.
    ...
    checks.append({
        ...
        "pass": bool(rnk["spans_the_whole_physical_flavor_space"]
                     ...
                     and all(t["flavor_miss"] < 1e-10
                             ...
                             for t in rnk["direct_construction"]))})
...
def render_markdown(summary: dict) -> str:
    ...
    L += ["", "**Direct construction** — hit an arbitrary target `δy_F` using "
          "only mass-preserving directions:", "",
          "| trial | flavor miss | mass disturbance | `\\|δx\\|` |", "|--|--|--|--|"]
    for i, t in enumerate(rnk["direct_construction"]):
